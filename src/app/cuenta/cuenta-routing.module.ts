...
@NgModule({
  ...
  providers: [CuentaSaldoService, PersonaService, SubSucursalService, LocalidadService, NacionalidadService, PersonaService, SexoService, SubSucursalService, TipoDocumentoService, BancoServiceService, ConvenioService]
})
